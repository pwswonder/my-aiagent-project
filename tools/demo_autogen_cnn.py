...
"""
Demo: CNN family stages auto-generation
--------------------------------------
"""
...
spec = ab.autofill_custom_blocks(spec, family="cnn_family")
...
out_path = os.path.join(ROOT, ".generated", "cnn_family_autogen.py")
pathlib.Path(os.path.dirname(out_path)).mkdir(parents=True, exist_ok=True)
with open(out_path, "w", encoding="utf-8") as f:
    f.write(out_txt)

print("✅ CNN-family auto-gen completed")
