...
if not tpl: print("[ERROR] transformer.slot.v1.j2 not found."); sys.exit(1)
...
out_path = os.path.join(ROOT, ".generated", "transformer_decoder_opts_autogen.py")
pathlib.Path(os.path.dirname(out_path)).mkdir(parents=True, exist_ok=True)
with open(out_path, "w", encoding="utf-8") as f:
    f.write(out_txt)
print("✅ Transformer (options) auto-gen ->", out_path)
