...
tpl = os.path.join(ROOT, "services", "templates", "transformer.slot.v1.j2")
...
spec = ab.autofill_custom_blocks(spec, family="performer")
...
out_path = os.path.join(ROOT, ".generated", "performer_decoder_autogen.py")
pathlib.Path(os.path.dirname(out_path)).mkdir(parents=True, exist_ok=True)
with open(out_path, "w", encoding="utf-8") as f:
    f.write(out_txt)
print("✅ Performer decoder auto-gen ->", out_path)
